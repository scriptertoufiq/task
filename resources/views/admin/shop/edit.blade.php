                ...
                <div class="col-lg-12">
                    <div class="card card-Vertical card-default card-md mb-4">
                        ...
                        <div class="card-body py-md-30">
                            <form action="{{ url('admin/shop/update/' . $shop->id) }}" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                value="{{ $shop->name }}" required id="name" placeholder="Name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="price"
                                                value="{{ $shop->price }}" required id="price" placeholder="Price">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                            ...
                                            <select name="category" id="category" class="form-control">
                                                ...
                                                @foreach ($category as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ $category->id == $shop->category_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="sort_des"
                                                value="{{ $shop->sort_des }}" required id="sort_des"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="formGroupExampleInput" class="color-dark">Previously Uploaded
                                            Picture</label>
                                        <div class="form-group">
                                            <img height="70px" width="200px"
                                                src="{{ asset('admin/img/shop/thumbsnil/' . $shop->img) }}" alt="">
                                        </div>
                                        <div class="form-group">
